...
<script>
const data = [{ x: ${JSON.stringify(x)}, y: ${JSON.stringify(y)}, type: 'scatter', mode: 'lines', connectgaps: true, line: { color: '#22c55e', width: 2 }, hovertemplate: 'Date: %{x}<br>Spread (30d): %{y:.2%}<extra></extra>' }];
