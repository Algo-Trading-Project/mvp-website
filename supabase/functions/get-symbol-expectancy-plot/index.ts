...
Deno.serve(async (req) => {
  ...
  try {
    ...
    // Simplified logic: filter by positive predicted return for 'long'
    ...
    if (!maxDate) {
      const emptyHtml = '<html><body style="background:#0b1220;color:#e2e8f0;padding:16px">No data.</body></html>';
